	...
	function setup() {
		...
		var window = {
			...
			diffLayerType: function() { //弹出层类型为dialog时做出额外的初始化
				...
				self.dialogTempl = $('<div class="dialog"><div class="dialog-title" data-action="drag"><a href="javascript:;" class="close-btn" data-action="cancel"></a><span class="text">' + self.opts.title + '</span></div><div class="dialog-content"><div class="content-text"><span class="icon"></span><span class="text">' + self.opts.content + '</span></div></div><div class="dialog-btn-wrapper"><a href="javascript:;" class="btn" data-action="confirm">' + globalConfig.trans['t_013'] + '</a><a href="javascript:;" class="btn" data-action="cancel">' + globalConfig.trans['t_014'] + '</a></div></div>');
			...
			close: function(options, escBol) {
				var self = this;

				if (!options.esc && escBol) {
					return;
				}
